...
<svg
    version="1.1"
    id="cloudSnowMoonAltFill"
    class="climacon climacon_cloudSnowMoonAltFill"
    ...
    <g class="climacon_iconWrap climacon_iconWrap-cloudSnowMoonAltFill">
...
const CloudSnowMoonAltFill = (props) => {
...
export default CloudSnowMoonAltFill;
